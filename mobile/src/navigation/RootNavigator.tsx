...
// @MX:REASON: HomeScreen, WorkoutSelectionScreen, CameraScreen, SessionSummaryScreen이 모두 여기서 등록됨
...
export function RootNavigator(): React.JSX.Element {
  return (
    <Stack.Navigator initialRouteName="Home" screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="SessionSummaryScreen" component={SessionSummaryScreen} />
    </Stack.Navigator>
  );
}
